...
"""
This topology configures the BMV2 switches to use the ploss.p4 program, which attempts to detect packet loss
between the BMV2 switches.
"""
...
s2 = net.addSwitch('s2', cls=Bmv2Switch, json='./ploss.json',
                   loglevel='info', switch_config='./s2f_commands.txt')
s3 = net.addSwitch('s3', cls=Bmv2Switch, json='./ploss.json',
